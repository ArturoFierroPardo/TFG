"""
Inferencia y evaluacion de LLMs (DeepSeek-V3, Llama 3.3 70B, Qwen 2.5 72B) sobre
los benchmarks ToTTo, WebNLG y KELM a traves de OpenRouter.

Calcula metricas globales y por fila (ROUGE-L, METEOR, BLEU, BERTScore) y el
tiempo por fila. Procesa en paralelo con varios hilos y permite reanudar una
ejecucion interrumpida. El modo --fix reprocesa unicamente las filas con error.
...
Uso:
    python pipelineLLM.py --dataset totto --model deepseek
    python pipelineLLM.py --dataset kelm --model qwen --limit 100
    python pipelineLLM.py --dataset webnlg --model llama --fix
"""
